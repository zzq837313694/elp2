...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTitle" style="height: 50px; line-height: 50px; fonts-family: Microsoft Yahei; fonts-size: 20px; color: #333333; padding-left: 20px; background-image: url(data:image/png;base64,); border-bottom: 1px solid #999999; position: relative;">'
        inntHtml += '' + title + ''
